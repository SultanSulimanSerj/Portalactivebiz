# Project Portal - SaaS портал для управления проектами

Полнофункциональный SaaS портал для управления проектами и объектами с современным интерфейсом и всеми необходимыми модулями.
