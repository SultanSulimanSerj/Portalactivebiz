            ...
            <div className="flex items-center gap-x-4 ml-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-medium text-gray-900">{session?.user?.name || 'Пользователь'}</p>
                  <p className="text-xs text-gray-500">{session?.user?.email || 'email@example.com'}</p>
                </div>
              </div>
            </div>
          </div>
